...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dxxz9oi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dxxz9oi.containers.anotherwebservice.com/
...
```
git clone git@github.com:Fixitall188/container-dxxz9oi.git
cd container-dxxz9oi
```
...
```
docker attach container-dxxz9oi
```
